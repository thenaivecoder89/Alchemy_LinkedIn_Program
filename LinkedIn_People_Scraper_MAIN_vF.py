...
try:
    ...
    for item in master_data:
        ...
        try:
            ...
            minimum_end_year_value = int(datetime.today().year)
        candidate_total_unique_experience = int(
            datetime.today().year) - minimum_end_year_value  # added to manage overlapping experiences - leading to inflated total experience figures
        ...
        master_dict['TOTAL EXPERIENCE (in years)'].append(
            candidate_total_unique_experience)  # added to manage overlapping experiences - leading to inflated total experience figures
